...
- If new project (not fork):
  - Copy [ayelenbottari.com project files](https://github.com/ayelenbottari/ayelenbottari.com)
...
- `README.md` ⏩ edit baseURL ("ayelenbottari.com") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/ayelenbottari/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `ayelenbottari.com`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/ayelenbottari/domains)
  - `Set up a custom domains`
  - `ayelenbottari.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.ayelenbottari.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/ayelenbottari/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de ayelenbottari.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/ayelenbottari/forms)
...
1. [Servicios ayelenbottari.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
...
```
*ENTREGA WEB ayelenbottari.com:* https://seacomoseo.com/entrega/
```
